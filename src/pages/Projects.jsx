        ...
        <div className="projects-grid">
          {filtered.map((p, i) => (
            <div className="project-card" key={i}>
              {p.link ? (
                <a href={p.link} target="_blank" rel="noopener noreferrer" className="project-img" style={{ display: 'block', textDecoration: 'none' }}>
                  {p.title === "Style Dash" ? (
              ...
              <div className="project-body">
                ...
                <div className="project-tags" style={{ marginBottom: p.link ? '1rem' : '0' }}>
                ...
                {p.link && (
                  <a 
                    ...
                    className="btn-ghost" 
                    style={{ padding: '0.4rem 1rem', fontSize: '0.8rem', display: 'inline-block', textDecoration: 'none' }}
                  >
                    View Live Preview →
                  </a>
                )}
